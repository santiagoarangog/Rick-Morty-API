    ...
    (function() {
        ...
        function() {
            for (var t = document.querySelectorAll(".file-drop-area"), e = 0; e < t.length; e++) ! function(e) {
                ...
                t[e].querySelector(".file-drop-btn").addEventListener("click", function() { r.click() }), r.addEventListener("change", function() {
                    var e;
                    r.files && r.files[0] && ((e = new FileReader).onload = function(e) {
        ...
        function() {
            ...
            if (null !== s) {
                for (var e = 0; e < s.length; e++) ! function(e) {
                    ...
                    s[e].addEventListener("submit", function(e) { e && e.preventDefault(), "" === n.value && l(this, t, r, a, o) })
                }(e);
        ...
        function(e, t, a) { for (var r = 0; r < e.length; r++) t.call(a, r, e[r]) }(document.querySelectorAll(".tns-carousel-wrapper .tns-carousel-inner"), function(e, t) {
            var a = { container: t, controlsText: ['<i class="ai-arrow-left"></i>', '<i class="ai-arrow-right"></i>'], navPosition: "top", controlsPosition: "top", mouseDrag: !0, speed: 600, autoplayHoverPause: !0, autoplayButtonOutput: !1 };
            ...
            if (null != s) {
                for (var l = s.querySelectorAll("[data-goto]"), c = 0; c < l.length; c++) l[c].addEventListener("click", function(e) { r.goTo(this.dataset.goto - 1), e.preventDefault() });
                r.events.on("indexChanged", function() {
                    for (var e = r.getInfo(), t = 0; t < l.length; t++) l[t].classList.remove("active");
                    s.querySelector('[data-goto="' + e.displayIndex + '"]').classList.add("active")
                })
            }
            var i, d, u = n.querySelector(".tns-carousel-label");
            null != u && r.events.on("indexChanged", function() {
                var e = r.getInfo(),
                    e = o[e.index].dataset.carouselLabel;
                u.innerHTML = e
            }), null !== n.querySelector(".tns-carousel-progress") && (a = r.getInfo(), i = n.querySelector(".tns-current-slide"), t = n.querySelector(".tns-total-slides"), d = n.querySelector(".tns-carousel-progress .progress-bar"), i.innerHTML = a.displayIndex, t.innerHTML = a.slideCount, d.style.width = a.displayIndex / a.slideCount * 100 + "%", r.events.on("indexChanged", function() {
                var e = r.getInfo();
        ...
        function() {
            ...
            if (0 !== e.length || 0 !== t.length || 0 !== s.length) {
                ...
                for (var v = 0; v < t.length; v++) {
                    ...
                    if (t[v].classList.add("bar-chart-" + v), null != g) { p = JSON.parse(g); for (var y = 0; y < p.colors.length; y++) l = "\n        .bar-chart-".concat(v, " .ct-series:nth-child(").concat(y + 1, ") .ct-bar {\n            stroke: ").concat(p.colors[y], " !important;\n          }\n        "), c.appendChild(document.createTextNode(l)) }
                    new Chartist.Bar(t[v], m, h)
                }
                for (var b = 0; b < s.length; b++) ! function(e) {
                    var t, a = JSON.parse(s[e].dataset.pieChart),
                        r = s[e].dataset.seriesColor;
                    if (s[e].classList.add("cz-pie-chart-" + e), null != r) { t = JSON.parse(r); for (var n = 0; n < t.colors.length; n++) l = "\n        .cz-pie-chart-".concat(e, " .ct-series:nth-child(").concat(n + 1, ") .ct-slice-pie {\n            fill: ").concat(t.colors[n], " !important;\n          }\n        "), c.appendChild(document.createTextNode(l)) }
                    new Chartist.Pie(s[e], a, { labelInterpolationFnc: function(e) { return Math.round(e / a.series.reduce(o) * 100) + "%" } })
                }(b)
            }
        }(),
        function() {
            ...
            if (null != d)
                for (var e = 0; e < d.length; e++) {
                    var t = function(e) {
                        var t, a, r, n, o = d[e].dataset.countdown,
                        ...
                        setInterval(function() {
                            var e = (new Date).getTime(),
                                e = parseInt((o - e) / 1e3);
                            0 <= e && (t = parseInt(e / 86400), e %= 86400, a = parseInt(e / 3600), e %= 3600, r = parseInt(e / 60), e %= 60, n = parseInt(e), null != s && (s.innerHTML = parseInt(t, 10)), null != l && (l.innerHTML = a < 10 ? "0" + a : a), null != c && (c.innerHTML = r < 10 ? "0" + r : r), null != i && (i.innerHTML = n < 10 ? "0" + n : n))
                        }, 1e3)
                    }(e);
                    if ("object" === _typeof(t)) return t.v
                }
        ...
        function() {
            ...
            if (null !== o)
                for (var e = 0; e < o.length; e++) ! function(e) {
                    function t() { if (r.checked) { a.parentNode.classList.add("price-switch-on"); for (var e = 0; e < n.length; e++) n[e].innerHTML = n[e].dataset.newPrice } else { a.parentNode.classList.remove("price-switch-on"); for (var t = 0; t < n.length; t++) n[t].innerHTML = n[t].dataset.currentPrice } }
                    var a = o[e].querySelector(".form-switch"),
                        r = a.querySelector('input[type="checkbox"]'),
                        n = o[e].querySelectorAll(".price");
                    t(), r.addEventListener("change", function() { t() })
                }(e)
        }(),
        function() {
        ...
        function() {
            for (var n = document.querySelectorAll(".range-slider"), e = 0; e < n.length; e++) ! function(e) {
                ...
                noUiSlider.create(t, { start: [e.dataStartMin, e.dataStartMax], connect: !0, step: e.dataStep, pips: { mode: "count", values: 5 }, tooltips: !0, range: { min: e.dataMin, max: e.dataMax }, format: { to: function(e) { return "$" + parseInt(e, 10) }, from: function(e) { return Number(e) } } }), t.noUiSlider.on("update", function(e, t) {
                    e = (e = e[t]).replace(/\D/g, "");
                    t ? r.value = Math.round(e) : a.value = Math.round(e)
                }), a.addEventListener("change", function() { t.noUiSlider.set([this.value, null]) }), r.addEventListener("change", function() { t.noUiSlider.set([null, this.value]) })
            }(e)
        }(),
        function() {
            ...
            var a = function(e) {
                for (var e = document.querySelector(e), t = e.parentNode.querySelectorAll(".view"), a = 0; a < t.length; a++) t[a].classList.remove("show");
